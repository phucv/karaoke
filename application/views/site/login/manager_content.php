...
<div class="sub-container col-form">
    <div class="sub-col-form">
        <div id="teacher" class="student-tab tab-pane fade in tabcontent">
            <form method="POST" class="e_ajax_submit" action="<?php echo $login_url; ?>"
                  data-ajax--url="<?php echo $login_url; ?>">
                <div class="title-login text-center" style="margin-top: 25px;"><?php echo get_string("v-manager-login"); ?></div>
