...
-- ----------------------------
BEGIN;
INSERT INTO `users` VALUES (1, 1, 'admin', '4297f44b13955235245b2497399d7a93', 'Admin', 'assets/images/default-avatar.png', NULL, NULL, 1, '6qe9hjk4v8hkvar5shrpg4fc3js20jhc', '2023-09-29 10:17:06', NULL, '2023-10-04 17:14:05', 1, 0);
INSERT INTO `users` VALUES (2, 2, 'nhan_vien', '4297f44b13955235245b2497399d7a93', 'Nhân viên', 'assets/images/default-avatar.png', '0384550110', 'male', 1, NULL, '2023-09-29 10:17:06', NULL, '2023-10-03 11:40:07', 2, 0);
COMMIT;
...
CREATE TABLE `users_role` (
  ...
  `role_data` text CHARACTER SET utf8 COMMENT '*.*;home.*',
  `role_data_limit` text COLLATE utf8_unicode_ci,
...
INSERT INTO `users_role` VALUES (2, 'Nhân viên', 'nv', NULL, '*.*', NULL, NULL, 'view', NULL, '2023-09-29 10:17:06', NULL, NULL, NULL, 0);
COMMIT;
